...
![image-20210728114623700](images/mysql高级.assets\image-20210728114623700.png)
...
possible_keys：显示可能应用在这张表的所有索引，一个或多个，不一定会实际使用
...
![image-20210804161050194](images/mysql高级.assets/image-20210804161050194.png)
